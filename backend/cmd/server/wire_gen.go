...
func initializeApplication(buildInfo handler.BuildInfo) (*Application, error) {
	...
	referralService := service.NewReferralService(referralRepository, userRepository, billingCacheService, configConfig)
	...
	paymentService := service.NewPaymentService(paymentOrderRepository, rechargePackageRepository, userRepository)
	adminPaymentHandler := admin.NewAdminPaymentHandler(paymentService)
	adminHandlers := handler.ProvideAdminHandlers(dashboardHandler, adminUserHandler, groupHandler, accountHandler, adminAnnouncementHandler, oAuthHandler, openAIOAuthHandler, geminiOAuthHandler, antigravityOAuthHandler, proxyHandler, adminRedeemHandler, promoHandler, settingHandler, opsHandler, systemHandler, adminSubscriptionHandler, adminUsageHandler, userAttributeHandler, errorPassthroughHandler, vendorHandler, adminPaymentHandler)
