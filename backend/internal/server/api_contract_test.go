...
func newContractDeps(t *testing.T) *contractDeps {
	...
	adminService := service.NewAdminService(userRepo, groupRepo, &accountRepo, nil, proxyRepo, apiKeyRepo, redeemRepo, nil, nil, nil, nil, nil, nil, nil)
...
func (stubProxyRepo) ListByGroupName(ctx context.Context, groupName string) ([]service.Proxy, error) {
	return nil, errors.New("not implemented")
}

func (stubProxyRepo) ListGroupNames(ctx context.Context) ([]string, error) {
	return nil, errors.New("not implemented")
}

func (stubProxyRepo) CountAccountsByGroupName(ctx context.Context) (map[string]int64, error) {
	return nil, errors.New("not implemented")
}
