...
exports.toKebabCase = exports.generateCSSVarMap = exports.cssVar = void 0;
 ...
 */
var generateCSSVarMap = exports.generateCSSVarMap = function generateCSSVarMap() {
  var prefix = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : 'ant';
  var token = _antd.theme.getDesignToken();
  var cssVar = {};
 ...
 */
var cssVar = exports.cssVar = generateCSSVarMap();