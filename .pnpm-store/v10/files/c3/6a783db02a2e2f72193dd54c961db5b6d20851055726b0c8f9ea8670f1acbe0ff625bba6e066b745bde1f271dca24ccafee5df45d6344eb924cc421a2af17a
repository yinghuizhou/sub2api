...
exports.createStaticStylesFactory = exports.createStaticStyles = void 0;
Object.defineProperty(exports, "cssVar", {
  enumerable: true,
  get: function get() {
    return _cssVar.cssVar;
  }
});
Object.defineProperty(exports, "generateCSSVarMap", {
  enumerable: true,
  get: function get() {
    return _cssVar.generateCSSVarMap;
  }
});
...
var defaultEmotion = (0, _core.createEmotion)({
  key: _core.DEFAULT_CSS_PREFIX_KEY,
  speedy: false
});
 ...
 * ```
 */
var createStaticStylesFactory = exports.createStaticStylesFactory = function createStaticStylesFactory() {
  ...
  // 根据 prefix 生成 cssVar
  var customCssVar = (0, _cssVar.generateCSSVarMap)(prefix);

  // 使用提供的 cache 或默认的全局 cache
  var emotionCache = cache !== null && cache !== void 0 ? cache : defaultEmotion.cache;

  // 创建 css 和 cx 函数
  var _createCSS = (0, _core.createCSS)(emotionCache, {
 ...
 * @returns 样式对象
 */
var createStaticStyles = exports.createStaticStyles = defaultInstance.createStaticStyles;
