export default {
  ...
  admin: {
    ...
    accounts: {
      ...
      proxyGroupPlaceholder: 'Enter group name, e.g.: US-East Shared',
      proxyGroupHint: 'Shared proxy group name, lower priority than dedicated proxy',
      autoAssignProxy: 'Auto Assign',
      autoAssignProxySuccess: 'Proxy auto-assigned: {group}',
      autoAssignProxyFailed: 'Auto-assign failed',
      testProxyConnectivity: 'Test Connectivity',
      testProxySuccess: 'Connectivity OK, latency {latency}ms, exit IP: {ip}',
      testProxyFailed: 'Connectivity test failed',
      concurrency: 'Concurrency',
      priority: 'Priority',
      ...
      quickModeDesc: 'Paste Session Key to add quickly',
      standardModeDesc: 'Configure all options',
      quickSessionKeyPlaceholder: 'Paste Session Key, one per line (batch supported)',
      quickNamePlaceholder: 'Leave empty to auto-generate (recommended)',
      quickSessionKeyHelp: 'Open claude.ai → F12 DevTools → Application → Cookies → Copy __Secure-sessionKey value',
      quickSessionKeyRequired: 'Please paste at least one Session Key',
      quickAuthMethod: 'Auth Method',
      quickAuthOAuth: 'OAuth (full access)',
      quickAuthSetupToken: 'Setup Token (inference only)',
      quickOptionalSettings: 'Optional Settings',
    ...
    proxies: {
      ...
      healthCheckAllRunning: 'Running health check...',
      healthCheckAllDone: 'Health check completed: {healthy} healthy, {unhealthy} unhealthy, {errors} errors',
      healthCheckAllFailed: 'Health check failed',
      importManifest: 'Import Manifest',
      importManifestTitle: 'Import Astrill Manifest',
      importManifestHint: 'Select an Astrill JSON manifest file to batch import VPN proxies.',
      importManifestFailed: 'Failed to import manifest',
